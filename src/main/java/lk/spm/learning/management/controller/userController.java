...
public class userController {
    ...
    //Add user
    @PostMapping("/login")
    public ResponseEntity<?> loginUser( @RequestBody loginUser loginUserDetails) {
        try {
            System.out.println("user is " + loginUserDetails.getPassword());
            String id = loginUserRepository.getUserByName(loginUserDetails);
